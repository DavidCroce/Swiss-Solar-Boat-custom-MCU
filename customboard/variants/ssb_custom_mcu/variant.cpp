...
const PinDescription g_APinDescription[PINS_COUNT]=
{
  // 0..13 - Digital pins
  // ----------------------
  // 0/1 - SERCOM/UART (Serial1) -> also RX/TX CAN software led
  ...
  { PORTA,  3, PIO_ANALOG, PIN_ATTR_ANALOG, ADC_Channel1, NOT_ON_PWM, NOT_ON_PWM, EXTERNAL_INT_NONE },
  ...
  // 47..49 personnal add analog pin
  { PORTB,  6, PIO_ANALOG, PIN_ATTR_ANALOG, ADC_Channel8, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },
  ...
  // 88..89 personnal add CAN0 TX RX
